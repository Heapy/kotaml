        ...
        context("a YAML serializer") {
            ...
            context("serializing string values") {
                ...
                context("serializing a string longer than the maximum scalar width") {
                    val output =
                        Yaml(configuration = YamlConfiguration(breakScalarsAt = 80))
                            .encodeToString(
                                String.serializer(),
                ...
                context("serializing a string with the value of an integer using PlainExceptAmbiguous") {
                    val yaml =
                        Yaml(
                            configuration =
                                YamlConfiguration(
                ...
                context("serializing a string with the value of a boolean using PlainExceptAmbiguous") {
                    val yaml =
                        Yaml(
                            configuration =
                                YamlConfiguration(
                ...
                context("serializing a string with the value of a float using PlainExceptAmbiguous") {
                    val yaml =
                        Yaml(
                            configuration =
                                YamlConfiguration(
                ...
                context("serializing an unambiguous numerical string using PlainExceptAmbiguous") {
                    val yaml =
                        Yaml(
                            configuration =
                                YamlConfiguration(
                ...
                context("serializing an int using PlainExceptAmbiguous") {
                    val yaml =
                        Yaml(
                            configuration =
                                YamlConfiguration(
                ...
                context("serializing a float using PlainExceptAmbiguous") {
                    val yaml =
                        Yaml(
                            configuration =
                                YamlConfiguration(
                ...
                context("serializing a boolean using PlainExceptAmbiguous") {
                    val yaml =
                        Yaml(
                            configuration =
                                YamlConfiguration(
                ...
                context(
                    "serializing a string with the value of an integer using PlainExceptAmbiguous, escaping with single-quotes",
                ) {
                    val output =
                        Yaml(
                            configuration =
                ...
                context(
                    "serializing a string with the value of a boolean using PlainExceptAmbiguous, escaping with single-quotes",
                ) {
                    val output =
                        Yaml(
                            configuration =
                ...
                context(
                    "serializing a string with the value of a float using PlainExceptAmbiguous, escaping with single-quotes",
                ) {
                    val output =
                        Yaml(
                            configuration =
            ...
            context("serializing serial names using YamlNamingStrategies") {
                @Serializable
                data class NamingStrategyTestData(
                ...
                context("serializing a long serial name with multiple words using a YamlNamingStrategy") {
                    @Serializable
                    data class LongSerialName(
                        val reallyLongSerialName: String,
                    )
                    val output =
                        Yaml(
                            configuration = YamlConfiguration(yamlNamingStrategy = YamlNamingStrategy.SnakeCase),
                ...
                context("serializing a serial name of only one character using a YamlNamingStrategy") {
                    @Serializable
                    data class OneCharacterSerialName(
                        val a: String,
                    )
                    val output =
                        Yaml(
            ...
            context("serializing lists") {
                ...
                context("serializing a list of integers in flow form") {
                    val output =
                        Yaml(configuration = YamlConfiguration(sequenceStyle = SequenceStyle.Flow))
                ...
                context("serializing a list of integers in flow form with sequence block indent") {
                    val output =
                        Yaml(configuration = YamlConfiguration(sequenceStyle = SequenceStyle.Flow, sequenceBlockIndent = 2))
                            .encodeToString(ListSerializer(Int.serializer()), listOf(1, 2, 3))
                ...
                context("serializing a list of integers without sequence block indent") {
                    val output =
                        Yaml(configuration = YamlConfiguration(sequenceBlockIndent = 0))
                            .encodeToString(ListSerializer(Int.serializer()), listOf(1, 2, 3))
                ...
                context("serializing a list of integers with sequence block indent") {
                    val output =
                        Yaml(configuration = YamlConfiguration(sequenceBlockIndent = 2))
                            .encodeToString(ListSerializer(Int.serializer()), listOf(1, 2, 3))
                ...
                context("serializing a list of strings with a string longer than the maximum scalar width") {
                    ...
                    val longString =
                        "Hello world this is a string that is much, much, much (ok, not that much) longer than 80 characters"
                    val output =
                        yamlWithScalarLimit.encodeToString(
                            ListSerializer(String.serializer()),
                            listOf("item1", longString),
                        )
                ...
                context("serializing a list of strings with a string longer than the maximum scalar width in flow form") {
                    val yamlWithScalarLimit =
                        Yaml(
                            configuration = YamlConfiguration(breakScalarsAt = 80, sequenceStyle = SequenceStyle.Flow),
                        )
                    val longString =
                        "Hello world this is a string that is much, much, much (ok, not that much) longer than 80 characters"
                    val output =
...
@Serializable
private data class ThingWithMap(

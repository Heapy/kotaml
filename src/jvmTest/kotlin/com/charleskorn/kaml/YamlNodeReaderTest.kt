        ...
        describe("a YAML node reader") {
                            ...
                            YamlList(
                                listOf(
                                    ...
                                    YamlScalar(
                                        "thing1",
                                        YamlPath.root
                                            .withListEntry(2, Location(3, 3))
                                            .withAliasReference("thing", Location(3, 3))
                                            .withAliasDefinition("thing", Location(1, 3)),
                                    ),
                                ),
                                YamlPath.root,
                            )
                            ...
                            YamlList(
                                listOf(
                                    ...
                                    YamlScalar(
                                        "thing3",
                                        YamlPath.root
                                            .withListEntry(4, Location(5, 3))
                                            .withAliasReference("thing", Location(5, 3))
                                            .withAliasDefinition("thing", Location(4, 3)),
                                    ),
                                ),
                                YamlPath.root,
                            )
            ...
            context("given some input representing a list of strings with a reference to a non-existent anchor") {
                ...
                describe("parsing that input with anchor and alias parsing enabled") {
                    it("throws an appropriate exception") {
                        val exception =
                            shouldThrow<UnknownAnchorException> {
                                val parser = YamlParser(input)
                ...
                describe("parsing that input") {
                    it("throws an appropriate exception") {
                        ...
                        exception.asClue {
                            ...
                            it.path shouldBe
                                YamlPath.root
                                    .withMapElementKey("thing", Location(1, 1))
                                    .withMapElementValue(Location(2, 3))
                                    .withError(Location(3, 8))
                        }
                    }
                }
            }
            ...
            context("given a map with multiple maps to merge into it") {
                ...
                describe("parsing that input") {
                    ...
                    val centerMergeResolutionPath =
                        thirdItemPath
                            .withMerge(Location(4, 8))
                            .withListEntry(0, Location(4, 10))
                            .withAliasReference("CENTER", Location(4, 10))
                            .withAliasDefinition("CENTER", Location(1, 3))
                    ...
                    val radiusMergeResolutionPath =
                        thirdItemPath
                            .withMerge(Location(4, 8))
                            .withListEntry(1, Location(4, 19))
                            .withAliasReference("RADIUS", Location(4, 19))
                            .withAliasDefinition("RADIUS", Location(2, 3))
            ...
            context("given a map with multiple maps to merge into it, with both source and destination maps containing the same keys") {
                ...
                describe("parsing that input") {
                    ...
                    val leftMergeResolutionPath =
                        fourthItemPath
                            .withMerge(Location(5, 8))
                            .withListEntry(1, Location(5, 16))
                            .withAliasReference("LEFT", Location(5, 16))
                            .withAliasDefinition("LEFT", Location(1, 3))
                    val fourthYPath = leftMergeResolutionPath.withMapElementKey("y", Location(1, 17))
                    val bigMergeResolutionPath =
                        fourthItemPath
                            .withMerge(Location(5, 8))
                            .withListEntry(0, Location(5, 10))
                            .withAliasReference("BIG", Location(5, 10))
                            .withAliasDefinition("BIG", Location(2, 3))
                ...
                describe("parsing that input") {
                    it("throws an appropriate exception stating that merging a null value is not valid") {
                        ...
                        exception.asClue {
                            ...
                            it.path shouldBe
                                YamlPath.root
                                    .withListEntry(0, Location(1, 3))
                                    .withMerge(Location(1, 8))
                                    .withListEntry(0, Location(1, 9))
                        }
                    }
                }
            }
            ...
            context("given a top-level map with a key matching the extension definition prefix but no anchor defined") {
                ...
                describe("parsing that input") {
                    it("throws an appropriate exception stating that an anchor is required for keys with the extension definition prefix") {
                        val exception =
                            shouldThrow<NoAnchorForExtensionException> {
                                val parser = YamlParser(input)
